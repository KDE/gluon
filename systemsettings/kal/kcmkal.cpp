...
K_EXPORT_PLUGIN(KALConfigFactory("kcmkal"))

KALConfig::KALConfig(QWidget *parent, const QVariantList &)
	: KCModule(KALConfigFactory::componentData(), parent)
{
 ...
 KAboutData *about = new KAboutData(
   ...
   KALInfoWidget * widget = new KALInfoWidget;
