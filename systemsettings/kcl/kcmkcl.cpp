...
K_EXPORT_PLUGIN(KCLConfigFactory("kcmkcl"))

KCLConfig::KCLConfig(QWidget *parent, const QVariantList &)
	: KCModule(KCLConfigFactory::componentData(), parent)
{
 ...
 KAboutData *about = new KAboutData(
   ...
   KCLInfoWidget * widget = new KCLInfoWidget;
