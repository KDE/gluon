...
/**
 * \class AtomicFile atomicfile.h <AtomicFile>
 *
 ...
 * to be corrupt.
 *
 * When you create a AtomicFile for a given file, a temporary file is instead
 * created and all your I/O occurs in the atomic file. Once you call finalize()
 ...
 * the target file is untouched. AtomicFile derives from QFile so you can use
 ...
 *
 * Here is a quick example of how to use AtomicFile:
 *
 * First we create the AtomicFile and open it.
 *
 * @code
 * AtomicFile atomicFile;
 * atomicFile.setFileName("/lib/foo/bar.dat");
 * if ( !atomicFile.open() ) {
 *     //Handle error
 * }
 * @endcode
