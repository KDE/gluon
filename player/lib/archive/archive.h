...
/**
 * Archive is a base class for reading and writing archives.
 * @short generic class for reading/writing archives
 * @author David Faure <faure@kde.org>
 * @author Laszlo Papp <lpapp@kde.org>
 */
class GLUON_PLAYER_EXPORT Archive
{
    protected:
        /**
    ...
    public:
         ...
         */
        const ArchiveDirectory* directory() const;
        ...
        enum
        {
            UnknownTime = static_cast<time_t>( -1 )
        };

        /**
         * If an archive is opened for writing then you can add new directories
         * using this function. Archive will not write one directory twice.
         *
         ...
         * For zip files, size is not used.
         *
         * This method also allows some file metadata to be
         * set. However, depending on the archive type not all metadata might be
         * regarded.
    ...
    protected:
         ...
         */
        virtual ArchiveDirectory* rootDir();
         ...
         * This handles e.g. tar files missing directory entries
         * @param path the path of the directory
         * @return the directory with the given @p path
         */
        ArchiveDirectory* findOrCreate( const QString& path );
         ...
         * Note that Archive will -not- own the device, it must be deleted by the derived class.
         */
         ...
         */
        void setRootDir( ArchiveDirectory* rootDir );

    protected:
        virtual void virtual_hook( int id, void* data );

    private:
        ArchivePrivate* const d;
};

class ArchiveEntryPrivate;
/**
 * A base class for entries in an Archive.
 * @short Base class for the archive-file's directory structure.
 *
 * @see ArchiveFile
 * @see ArchiveDirectory
 */
class GLUON_PLAYER_EXPORT ArchiveEntry
{
    public:
        /**
         * Creates a new entry.
         ...
         */
        ArchiveEntry( Archive* archive, const QString& name, int access, int date,
                      const QString& user, const QString& group,
 ...
 * @see ArchiveDirectory
 */
class GLUON_PLAYER_EXPORT ArchiveFile : public ArchiveEntry
{
    public:
        /**
         ...
         * @param size the size of the file
         */
        ArchiveFile( Archive* archive, const QString& name, int access, int date,
                     const QString& user, const QString& group, const QString& symlink,
                     qint64 pos, qint64 size );

        /**
         * Destructor. Do not call this, Archive takes care of it.
         */
        virtual ~ArchiveFile();
 ...
 * @see ArchiveFile
 */
class GLUON_PLAYER_EXPORT ArchiveDirectory : public ArchiveEntry
{
    public:
        /**
         ...
         * @param symlink the symlink, or QString()
         */
        ArchiveDirectory( Archive* archive, const QString& name, int access, int date,
                          const QString& user, const QString& group,
                          const QString& symlink );
         ...
         */
        const ArchiveEntry* entry( const QString& name ) const;

        /**
         * @internal
         * Adds a new entry to the directory.
         */
        void addEntry( ArchiveEntry* );
    ...
    protected:
        virtual void virtual_hook( int id, void* data );
    private:
        ArchiveDirectoryPrivate* const d;
};
