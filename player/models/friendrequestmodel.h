...
#ifndef GLUON_PLAYER_FRIENDREQUESTMODEL_H
#define GLUON_PLAYER_FRIENDREQUESTMODEL_H
...
namespace GluonPlayer
{
     ...
     *
     */
    class GLUON_PLAYER_EXPORT FriendRequestModel : public QAbstractListModel
    {
            Q_OBJECT
        ...
        public:
            ...
            explicit FriendRequestModel( QObject* parent = 0 );
            virtual ~FriendRequestModel();
        ...
        public  Q_SLOTS:
            Q_INVOKABLE void fetchRequests( );
 
        private Q_SLOTS:
            void processFetchedFriendRequest();
...
#endif // GLUON_PLAYER_FRIENDREQUESTMODEL_H