...
function move(time)
{
    ...
    if(self.GameObject.Key_Left2.isActionHeld())
    {
        self.GameObject.translate(-addX, 0, 0);
    }

    if(self.GameObject.Key_Right2.isActionHeld())
    {
        self.GameObject.translate(addX, 0, 0);
    }
...
function rotate()
{
    self.GameObject.rotate(-2.5 * (Math.PI/180.), new Vector3f(0,0,1));
}

function jump()
{
    if (self.GameObject.Key_Jump2.isActionHeld()) {
        gJumpingBool = true;
    }
