...
////    setupGUI(gluon_bteditor.rc);
////    createGUI(gluon_bteditor.rc);

//    m_part = new KParts::PartManager( this );
//    // When the manager says the active part changes,
//    // the builder updates (recreates) the GUI
//    connect( m_part, SIGNAL( activePartChanged( KParts::Part * ) ),this, SLOT( createGUI( KParts::Part * ) ) );
//    //query the .desktop file to load the requested Part
//    KService::Ptr service = KService::serviceByDesktopPath
//                           ("gluon_bteditor.desktop");

//    if (service)
//    {
//        m_part = service->createInstance<bteditor>(0);
...
//        KMessageBox::error(this, "service gluon_bteditor.desktop not found");
//        qApp->quit();
...
//void bteditor::load(const KUrl& url)
//{
//    m_part->openUrl( url );
//}
