...
void KCLButton::setDeviceIcon(KCL::DeviceFlag device)
{
    switch (device)
    {
            case KCL::Mouse: m_currentIcon = KIcon("input-mouse.png");break;
            case KCL::Touchpad: m_currentIcon = KIcon("input-mouse.png");break;
            case KCL::KeyBoard: m_currentIcon = KIcon("input-keyboard.png");break;
            case KCL::Joystick: m_currentIcon = KIcon("input-gaming.png");break;
            case KCL::Tablet: m_currentIcon = KIcon("input-tablet.png");break;
            case KCL::Unknown: m_currentIcon = KIcon("system-help.png");break;
            }
