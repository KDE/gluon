...
public:
    ...
    void setButtonCode(int code) {
        m_buttonCode = code;
    }
    void setInput(KCLInput * input) {
        m_input = input;
    }
private:
    QString m_name;
...
public:
    ...
    QList<VirtualButton*>primaryButtonList() {
        return m_primaryButtonList;
    }
    QList<VirtualButton*>secondaryButtonList() {
        return m_secondaryButtonList;
    }

    QList <VirtualButton*> primary() {
        return m_primaryButtonList;
    }
    QList <VirtualButton*> secondary() {
        return m_secondaryButtonList;
    }
private:
