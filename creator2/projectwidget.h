...
#ifndef GLUON_CREATOR_PROJECTWIDGET_H
#define GLUON_CREATOR_PROJECTWIDGET_H
...
namespace GluonCreator
{
    ...
    class ProjectWidget : public QWidget
    {
            Q_OBJECT
        public:
            explicit ProjectWidget( const QString& title, QWidget* parent = 0, Qt::WindowFlags flags = 0 );
