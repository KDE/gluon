...
class SceneView::SceneViewPrivate
{
    public:
        SceneViewPrivate()
            : model( 0 )
...
void SceneView::selectionChanged( QItemSelection selected, QItemSelection /* deselected */ )
{
    DEBUG_FUNC_NAME
...
void SceneView::sceneChanged( GluonEngine::Scene* obj )
{
    if( obj )
    {
...
void SceneView::newGameObjectAction()
{
