...
GluonCore::GluonObjectList OtherPlugin::typesToRegister()
{
    return GluonCore::GluonObjectList()
        << new AchievementsAsset(this)
        << new SphereCollisionComponent(this)
        << new StatisticsAsset(this)
        << new StatisticsComponent(this);
}
