...
#ifndef GLUON_ENGINE_PARTICLEANIMATOR_H
#define GLUON_ENGINE_PARTICLEANIMATOR_H
...
namespace GluonEngine
{
    ...
    class GLUON_COMPONENT_PARTICLEANIMATOR_EXPORT ParticleAnimatorComponent : public Component
    {
            Q_OBJECT
        ...
        public:
            Q_INVOKABLE ParticleAnimatorComponent( QObject* parent = 0 );
            ~ParticleAnimatorComponent();
