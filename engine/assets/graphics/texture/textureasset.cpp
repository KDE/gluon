...
QVariant
TextureAsset::toVariant(GluonCore::GluonObject* wrapThis)
{
    return QVariant::fromValue<GluonEngine::TextureAsset*>(qobject_cast<GluonEngine::TextureAsset*>(wrapThis));
}
