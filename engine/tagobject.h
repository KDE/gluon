...
namespace GluonEngine
{
    ...
    class GLUON_ENGINE_EXPORT TagObject : public GluonCore::GluonObject
    {
            ...
            QStringList objectsFromScene( GluonEngine::GameObject * scene );
            /**
        ...
        public:
            ...
            */
            Q_INVOKABLE QList<QString> tags( GluonEngine::GameObject* );
            Q_INVOKABLE QString tags( QString objectname );
            /**
            * Get the parent(base) object name
            */
            Q_INVOKABLE QString baseName( QString objectname );
            /**
            * Get all the objects associated with a tag
            */
            Q_INVOKABLE QList<QString> objects( QString tag );
            /**
            * Pass a scene with it, to get cloned objects too
            */
            Q_INVOKABLE QList<QString> objects( GluonEngine::GameObject* scene, QString tag );
            /**
